...
<div class="col-md-12 mb-3">
 ...
 <!--(START)BOOKING CANCELLATION  FORM //CHAMIKA -->
<br>
<br>
<br>
<br>
...
<div class = "container" >
<h1 align ="center" class="display-3">Your Booking is Cancelled !</h1>
<%
String id=request.getParameter("ID");
try
{
	Class.forName("com.mysql.jdbc.Driver");
	Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/hellotaxi", "root", "91739173");
	Statement st=conn.createStatement();
	int i=st.executeUpdate("DELETE FROM Reservation WHERE id="+id);
...
<br>
 <!--(END)BOOKING CANCELLATION  FORM //CHAMIKA -->
