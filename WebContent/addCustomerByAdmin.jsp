...
<script> 
	...
	{ 
		 ...
		 var password1 = document.addCustomer.password1.value; 
		 var password2 = document.addCustomer.password2.value;
		 var address = document.addCustomer.address.value;
		 var zip = document.addCustomer.zip.value;
		 var contactNumber = document.addCustomer.contactNumber.value;
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="AddCustomerByAdminServlet" name="addCustomer" method="post" class="" onsubmit="return validateAddCustomer()">
