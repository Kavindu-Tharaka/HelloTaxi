...
<main><!-- Chamika me Main eka athule Revervation eka ganna form eka hadanna ona --> 
		...
		<div class="container-fluid">
	        <div class="row">
	            <div class="col-md-4 text-left"><h3>Reservation List</h3></div>
	        ...
	        <div class="table-responsive">
		        <table class="table table-hover table-dark table-condensed">
		            ...
		            <tbody>
		                ...
		                if(query != null)
		                {
		                	data = " select * from Reservation where fname like '%" + query + "%' or lname like '%" + query + "%'";
		                }
		                else
		                {
