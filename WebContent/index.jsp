...
<script> 
	...
	{ 
		 var name = document.driverRegistraion.name.value;
		 var uname = document.driverRegistraion.uname.value;
		 var pwd = document.driverRegistraion.pwd.value; 
		 var rpwd = document.driverRegistraion.rpwd.value;
		 var add = document.driverRegistraion.add.value;
		 var nic = document.driverRegistraion.nic.value;
		 var licen = document.driverRegistraion.licen.value;
		 var age = document.driverRegistraion.age.value;
		 var gender = document.driverRegistraion.gender.value;
		 var type = document.driverRegistraion.type.value;
		 var vreg_no = document.driverRegistraion.vreg_no.value;
		 ...
		 else if (vreg_no == null || vreg_no == "")
		 { 
			 alert("Please enter vehicle registration number"); 
			 return false; 
		 }
		 else if (vreg_no.length != 10 && vreg_no.length != 10)
		 { 
			 alert("Vehicle registration number can contains only 10 numbers"); 
			 return false; 
		 }
	 }
    ...
    <div class="modal fade" id="myModal-driver-signup" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form name= "driverRegistraion" action="RegisterDriverServlet" method="post" onsubmit="return validateDriverRegistration()" >
...
<main class="container"><!-- Chamika me Main eka athule Revervation eka ganna form eka hadanna ona --> 
