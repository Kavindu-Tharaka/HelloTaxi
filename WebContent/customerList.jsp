...
<main><!-- Chamika me Main eka athule Revervation eka ganna form eka hadanna ona --> 
		...
		<div class="container-fluid">
	        <div class="row">
	            <div class="col-md-4 text-left"><h3>Customer List</h3></div>
	            
	                 <form class="form-inline col-md-4" name="search" action="" method="post" >
				      <input class="form-control" name="searchQuery" type="search" placeholder="Search Customer">
				      <span>&nbsp</span>
				      <button class="btn btn-dark" type="submit">Search</button>
				    </form>
				    
	            <div class="col-md-4 text-right">
	                <a href="addCustomerByAdmin.jsp" class="btn btn-dark"><i class="fa fa-user-plus"></i>  Add New Customer</a>	            
	            </div>
	        </div>
	        <p></p>
	        <div class="table-responsive">
		        <table class="table table-hover table-dark table-condensed">
		            ...
		            <tbody>
		                ...
		                {
		                	data = " select ID,name,userName,address,zipCode,contactNumber from users where type = 'customer' and name like '%" + query + "%' or userName like '%" + query + "%' ";
		                }
		                else //if input field empty, then assign this SQL query to data variable
		                {
		                 	data = "select ID,name,userName,address,zipCode,contactNumber from users where type = 'customer' ";
		                }
		                ...
		                <tr>
		                    ...
		                    <td class="text-center" >
		                        <a href='editCustomerByAdmin.jsp?u=<%=rs.getString("ID")%>' class="btn btn-warning badge-pill">Edit</a> 
		                        <a href='deleteUserServlet?d=<%=rs.getString("ID")%>' class="btn btn-danger badge-pill">Delete</a>
		                    </td>
		                </tr>
		                <%
		                }
